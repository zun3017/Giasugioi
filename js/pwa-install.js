...
(function() {
  ...
  function showIOSInstallModal() {
    ...
    modal.innerHTML = [
      ...
      '  <h3 style="color: #FFF; margin: 0 0 8px; font-size: 17px; font-weight: 700;">Cài đặt App trên iPhone</h3>',
      '  <p style="color: #A6ADCE; font-size: 13px; margin: 0 0 18px; line-height: 1.4;">Chỉ mất 2 bước đơn giản để thêm biểu tượng Gia Sư vào màn hình chính của bạn:</p>',
      ...
      '      <div>Bấm nút <strong>Chia sẻ</strong> <i class="fa-solid fa-arrow-up-from-bracket" style="color: #3B82F6; margin: 0 2px;"></i> ở thanh công cụ dưới Safari.</div>',
      '    </div>',
      '    <div style="display: flex; align-items: center; gap: 10px;">',
      ...
      '      <div>Cuộn xuống chọn <strong>"Thêm vào MH chính"</strong> (Add to Home Screen) <i class="fa-regular fa-square-plus" style="color: #FFD23F; margin-left: 2px;"></i></div>',
      '    </div>',
      '    <div style="display: flex; align-items: center; gap: 10px;">',
      '      <div style="width: 24px; height: 24px; border-radius: 50%; background: #10B981; color: #FFF; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 11px; flex-shrink: 0;">✓</div>',
      '      <div>Bấm <strong>"Thêm" (Add)</strong> ở góc trên bên phải là hoàn tất!</div>',
      '    </div>',
      '  </div>',
